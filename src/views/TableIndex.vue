<template>
  <div class="table_index">
    ...
    <div>
      <saveTemplate :templateList="templateList" :tableShow="tableShow"></saveTemplate>
    </div>
    <el-container>
      <el-main v-loading="loading">
        <div class="content_main">
          <div v-for="(items,index) in dataList.result.words_region_list" :key="index">
            ...
            <div
              v-if="items.type == 'table' && items.words_block_list.length > 1"
              class="ttable"
            >
              <!-- {{items}} -->
              ...
              <el-button type="primary" style="position: absolute;margin-left: 20px;">导出</el-button>
            </div>
          </div>
        </div>
