    ...
    <div class="preview_header">
      <el-row>
        ...
        <el-col :span="8" style="text-align: right;">
          ...
          <!-- <el-button icon="iconfont icon-xiazai" title="Download" style="margin-right: 30px;"></el-button> -->
          <!-- <span>|</span> -->
...
export default {
  ...
  mounted() {
    ...
    $("#content_main").scroll(function () {
      ...
      var small = document.getElementsByClassName("canvasSmall");

      small.forEach((element, index) => {
        element.className = "canvasSmall";
        if (index == self.active) {
          element.className = "canvasSmall active_item ";
        }
      });

      target.scrollTop = self.active * 120;
    });
  },
  methods: {
    getUrl() {
    ...
    previousPage() {
      if (self.pageNum == 1) {
        ...
        self.disabledPreviousPage = false;
        ...
        for (let i = 1; i <= pages; i++) {
          ...
          pdf.getPage(i).then(function (page) {
            ...
            canvasSmall.onclick = function () {
              ...
              // var targetSmall = document.getElementById("content_side");
              // targetSmall.scrollTop = (self.j - 1) * 100;

              $(".canvasSmall").removeClass("active_item");
